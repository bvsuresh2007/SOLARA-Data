...
# These 8 already have addresses updated on SO, just need DN creation
# The fix: DON'T clear taxes array, just remove item_tax_template from items
orders = [
...
for sol, so_name in orders:
    ...
    if not shipping_addr:
        ...
        results.append((sol, 'NO_ADDR', so_name, '', cust))
        continue
    ...
    # DO NOT clear taxes - keep them from make_delivery_note
    # Just remove item_tax_template from items to avoid CGST/SGST vs IGST mismatch
