...
sol = 'SOL1194730'
dn = 'SHPDN27-09259'
shopify_oid = '7002723221736'

# Get address
r_a = requests.get(f'{BASE}/api/resource/Address/Ankur Srivastava-Shipping', headers=H, timeout=15)
...
for cp_id, cp_name in [(4, 'Delhivery'), (5, 'Bluedart')]:
    ...
    if meta.get('success') and meta.get('status') == 200:
        ...
        if 'already placed' in err.lower():
            print('  Cached result, will try -R2...')
            ref = sol + '-R2'
