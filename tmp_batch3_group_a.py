...
# Group A: Submitted DN, no AWB. Delhivery rejected PIN. Force Bluedart (cp_id=5).
group_a = [
    ('SOL1204710', 'SHPDN27-12027'),   # Shruti, 600007 Chennai
    ('SOL1204551', 'SHPDN27-12119'),    # Narendran, 600118 Chennai
    ('SOL1204432', 'SHPDN27-12231'),    # vaibhavi, 600099 Chennai
]

results = []

for sol, dn in group_a:
    print(f'\n{"="*70}')
    print(f'=== {sol} | DN={dn} ===')
    ...
    cp_payload = {
        ...
        'shipment_details': {
            ...
            'cod_value': 0,
            'courier_partner': 5,  # Bluedart forced
            'invoice_number': dn,
    ...
    if meta.get('success') and meta.get('status') == 200:
        ...
        if shopify_oid:
            ...
            if open_fos:
                ...
                # Try updating existing fulfillment
                ...
                if existing:
                    ...
                    payload = {
                        'fulfillment': {
                            'tracking_info': {'number': awb, 'url': tracking_url, 'company': 'Bluedart'},
                            'notify_customer': True,
                        }
                    }
        ...
        results.append((sol, 'OK', dn, awb, 'Bluedart'))
    else:
