...
sol = 'SOL1197706'
dn = 'SHPDN27-09170'
old_awb = '29044411167165'
shopify_oid = '7022305116392'
...
print(f'Items: {items_str} | Weight: {total_weight_g}g | Total: Rs {grand_total} | COD: {cod_amount}')
...
# Create new AWB with -R1 — PPCOD = COD for Clickpost
ref = sol + '-R1'
new_awb = ''
courier = ''
for cp_id, cp_name in [(4, 'Delhivery'), (5, 'Bluedart')]:
    cp_payload = {
        ...
        'shipment_details': {
            'order_type': 'COD', 'invoice_value': grand_total, 'reference_number': ref,
