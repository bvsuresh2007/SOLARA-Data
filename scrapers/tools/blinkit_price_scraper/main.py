...
Usage:
    python main.py <product_id_or_url>                           # Single product
    python main.py 627046 628123                                 # Multiple products
    python main.py -f products.txt                               # From file (URLs or IDs, one per line)
    python main.py -f products.txt -o resultsblinkit.csv         # Export to CSV
    python main.py -p 122009 -f products.txt -o results.csv     # Specific pincode
    python main.py --browser -f products.txt -o results.csv     # Browser mode (recommended)
"""
