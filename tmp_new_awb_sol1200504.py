...
sol = 'SOL1200504'
dn = 'SHPDN27-07259'
shopify_oid = '7041139671272'

# Get address
r_a = requests.get(f'{BASE}/api/resource/Address/Parth s patel-Shipping', headers=H, timeout=15)
...
if not new_awb:
    print('\nALL COURIERS FAILED — no AWB created')
    sys.exit(1)

# Save AWB to DN
sn = 'tmp_nawb_shpdn27_07259'
